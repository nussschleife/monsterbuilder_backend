...
INSERT INTO Charakter(level, name, lebenspunkte, ruestungsklasse, geschwindigkeit_ft) VALUES (1, 'StandardCharakterLevel1', 21, 20, 30);
INSERT INTO Charakter(level, name, lebenspunkte, ruestungsklasse, geschwindigkeit_ft) VALUES (2, 'StandardCharakterLevel2', 34, 22, 30);
INSERT INTO Charakter(level, name, lebenspunkte, ruestungsklasse, geschwindigkeit_ft) VALUES (3, 'StandardCharakterLevel3', 47, 23, 30);

INSERT INTO charakter_score(charakter_id, score_id) VALUES (1,1), (1,2), (1,3), (1,4), (1,5), (1,6);
INSERT INTO charakter_score(charakter_id, score_id) VALUES (2,1), (2,2), (2,3), (2,4), (2,5), (2,6);
INSERT INTO charakter_score(charakter_id, score_id) VALUES (3,1), (3,2), (3,3), (3,4), (3,5), (3,6);
INSERT INTO charakter_save(charakter_id, save_id) VALUES (1,2), (1,9),(1,1);
INSERT INTO charakter_save(charakter_id, save_id) VALUES (1,8), (1,3),(1,4);
INSERT INTO charakter_save(charakter_id, save_id) VALUES (1,5), (1,6),(1,7);

--angriffe__
INSERT INTO CHARAKTER_ANGRIFF VALUES (1,1), (2,2), (3,3);